package fr.matsurf.shopcart.web.websocket;

import fr.matsurf.shopcart.security.SecurityUtils;
import fr.matsurf.shopcart.web.websocket.dto.ActivityDTO;
...
import static fr.matsurf.shopcart.config.WebsocketConfiguration.IP_ADDRESS;
