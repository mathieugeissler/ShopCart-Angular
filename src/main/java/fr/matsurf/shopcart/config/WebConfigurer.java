package fr.matsurf.shopcart.config;
...
import fr.matsurf.shopcart.web.filter.CachingHttpHeadersFilter;
import fr.matsurf.shopcart.web.filter.StaticResourcesProductionFilter;
...
public class WebConfigurer implements ServletContextInitializer, EmbeddedServletContainerCustomizer {
    ...
    private void initClusteredHttpSessionFilter(ServletContext servletContext, EnumSet<DispatcherType> disps) {
        ...
        parameters.put("instance-name", "shopcart");
